			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="well">
						...
						<form class="form-horizontal" action="/member/regist.do" method="post">
							<fieldset>
								...
								<div class="row">
									<div class="col-2">
										<button type="submit" class="w-100 btn btn-primary">회원 등록</button> <%-- submit은 form에 action에 설정한값에 전송 --%>
									</div>
									<div class="col-2">
