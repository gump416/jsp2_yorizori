...
public class DaoFactory{
	...
	private DaoFactory() {
		loadProperties();
		BasicDataSource ds = new BasicDataSource(); //DataSource에는 set메소드가 없음
...
//		return new MybatisMemberRepository(dataSource); 구현체가바뀌면 여기만 바꿔주면됨 유지보수!!
	}
	/*
	 * 
	 public BoardDao getBoardDao() { //connectfactory 확장해서 만들었다고 생각하자 Daofactory
